...
/**
 * An MessagePill React Component.
 * @author Jane Will
 * @version 0.1
 */
export const MessagePill: React.FC<Props> = () => {
  ...
  return (
    <div className="relative">
      {isEnabled && (
        <div className="absolute right-0 bottom-14 rounded-full bg-navy-600 px-5 py-2.5">
                  ...
                  <div className="xl:w-80">
                    ...
                    {selectedContactReason === "job_offer" ? (
                      ...
                      <Input
                        ...
                        required
                        data-testid={
                          DataTestIds.CONTACT_ME_CONTACT_REASON_INPUT
                        }
                      />
                    )}
                  </div>
